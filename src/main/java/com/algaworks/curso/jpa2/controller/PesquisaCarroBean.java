...
import com.algaworks.curso.jpa2.dao.LazyGenericDataModel;
...
//	private LazyCarroDataModel lazyCarros;
	private LazyGenericDataModel<Carro> lazyCarros;
	
	private Carro carroSelecionado;
	
	public void inicializar() {
//		lazyCarros = new LazyCarroDataModel(carroDAO);
		lazyCarros = new LazyGenericDataModel<Carro>(carroDAO);
	}
	...
	public LazyGenericDataModel<Carro> getLazyCarros() {
		return lazyCarros;
	}
